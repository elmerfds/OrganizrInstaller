...
uti_menus() 
	{
		...
		echo
		echo "| 1.| Let's Encrypt: Test Single Domain Cert Renewal	  " 
		echo "| 2.| Let's Encrypt: Single Domain Cert Renewal 	  " 
		echo "| 3.| Let's Encrypt: Wilcard Cert Renewal	  " 
		echo "| 4.| Let's Encrypt: Wilcard Cert Renewal [Cloudflare DNS Plugin] 					  "
		echo "| 5.| Back 					  "
		echo
		echo
